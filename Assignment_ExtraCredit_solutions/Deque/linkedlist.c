...
// insert a new node at given position, pos is FRONT or END
...
// delete the given node x from the list and return it
...
// remove the given node x from the list and return it
